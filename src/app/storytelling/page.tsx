  ...
  return (
    <main className='w-screen'>
        <section className='min-h-screen'>
            <HeaderPengumpulan HeaderName={"Guidebook StoryTelling HFG 17th"}></HeaderPengumpulan>
            <div className=''>
                <iframe className='w-full h-screen' src='Guidebook_Lomba_StoryTelling.pdf'> </iframe>
            </div>
        </section>
    <Footer/>
    </main>
